...
func aoc(filepath string) {
	...
	result := 0
	scoreMap := []MatchScore{
		{Opponent: 'A', Player: 'X', Score: 3},
		{Opponent: 'A', Player: 'Y', Score: 4},
		{Opponent: 'A', Player: 'Z', Score: 8},
		{Opponent: 'B', Player: 'X', Score: 1},
		{Opponent: 'B', Player: 'Y', Score: 5},
		{Opponent: 'B', Player: 'Z', Score: 9},
		{Opponent: 'C', Player: 'X', Score: 2},
		{Opponent: 'C', Player: 'Y', Score: 6},
		{Opponent: 'C', Player: 'Z', Score: 7},
	}
